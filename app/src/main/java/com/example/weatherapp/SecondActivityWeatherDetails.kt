...
class SecondActivityWeatherDetails : AppCompatActivity() {
    ...
    fun cardinalPoint(): String {
        ...
        if (dataFromMainActivity.current.wind_dir == "SE") cardinalPoint = "de Sud-Est"
        if (dataFromMainActivity.current.wind_dir == "SSE") cardinalPoint = "de Sud-Sud-Est"
        if (dataFromMainActivity.current.wind_dir == "S") cardinalPoint = "de Sud"
        if (dataFromMainActivity.current.wind_dir == "SSW") cardinalPoint = "de Sud-Sud-Ouest"
        if (dataFromMainActivity.current.wind_dir == "SW") cardinalPoint = "de Sud-Ouest"
